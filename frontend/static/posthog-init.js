...
// register() runs BEFORE init() so the super property is already set when
// the automatic initial $pageview fires — otherwise the very first pageview
// of each session ships without app=hot-hog.
